...
int main() {
  ...
  ifstream fa("/Users/hui/Desktop/c++/C++/c_Primer_Plus/Chapter16/a.txt", ios_base::in);
  ifstream fb("/Users/hui/Desktop/c++/C++/c_Primer_Plus/Chapter16/b.txt", ios_base::in);
  if (!(fa && fb)) {
